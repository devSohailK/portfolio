    ...
    <section id="about" className="py-20 bg-transparent">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Highlights Cards with Framer Motion Hover & Neon Shadow */}
          <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
            <motion.div
              whileHover={{ y: -5, scale: 1.02 }}
              transition={{ type: "spring", stiffness: 300, damping: 20 }}
              className="bg-slate-900/50 backdrop-blur p-6 rounded-xl border border-purple-500/30 hover:border-purple-400 hover:shadow-[0_0_22px_rgba(168,85,247,0.55)] transition-all duration-300 cursor-default"
            >
              <h3 className="text-xl font-bold font-mono text-white mb-3 flex items-center gap-2">
                <span className="text-purple-400">⚡</span> Foundations
              </h3>
